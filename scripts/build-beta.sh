...
if [[ "$ARCH" == "help" || "$ARCH" == "--help" || "$ARCH" == "-h" ]]; then
    ...
    echo "  version      - Package version (default: test-beta-1.0.0)"
    echo
    ...
    echo "  $0 x86_64 my-test-1.0-beta  # Build with custom version"
    echo
...
echo "   ./scripts/build-beta.sh x86_64 my-test-1.2.3-beta.1"